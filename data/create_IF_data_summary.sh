...
cp /home/sbl/epidermal_data/compiled/create_IF_data_summary.sh  /home/sbl/epidermal_data/code/create_IF_data_summary.sh  

echo Executing create_IF_data_summary | tee -a $log
cd /home/sbl/epidermal_data/code
./create_IF_data_summary.sh /usr/local/MATLAB/MATLAB_Runtime/v85
